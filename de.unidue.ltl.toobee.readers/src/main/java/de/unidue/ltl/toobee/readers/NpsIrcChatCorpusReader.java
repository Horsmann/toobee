...
public class NpsIrcChatCorpusReader extends JCasResourceCollectionReader_ImplBase {
	...
	private boolean closeReaderOpenNext() throws CollectionException, IOException {
		...
		LogFactory.getLog(getClass()).warn(this.getClass().getName() + "--> read: " + countFiles + " files with "
				+ countPosts + " posts and " + countTokens + " tokens");
		return false;
	}
