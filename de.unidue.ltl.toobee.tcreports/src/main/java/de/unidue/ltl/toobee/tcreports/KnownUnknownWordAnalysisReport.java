    ...
    implements Constants
{
    ...
    public static List<File> oov_all = new ArrayList<>();
    public static List<File> iv_all = new ArrayList<>();
        ...
        throws Exception
    {
        ...
        evaluate(store, outputFolderId + "/");
    }

    private void evaluate(StorageService store, String outputContext)
        throws Exception
    {
        ...
        throws IOException
    {
        ...
        for (File o : files) {
            ...
            acc_line = acc_line.replaceAll(",", ".");
            avg_acc += Double.valueOf(acc_line);
